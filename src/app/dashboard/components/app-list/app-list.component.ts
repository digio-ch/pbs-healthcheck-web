...
import { QuapSharedAppPreviewComponent } from '../../../apps/quap/components/quap-shared-app-preview/quap-shared-app-preview.component';
...
@Component({
    ...
    imports: [WidgetsAppPreviewComponent, QuapAppPreviewComponent, QuapSharedAppPreviewComponent, CensusAppPreviewComponent, OverviewDepartmentsAppPreviewComponent, TranslatePipe, MyOrganizationPreviewChartComponent, MyOrganizationPreviewTooltipComponent]
})
